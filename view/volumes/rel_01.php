...
<body>
  ...
  <div id="cabecalho" style="float:left; width:100%;">
      <span style="float:left;width:40%;font-size:18pt;">RELAT&Oacute;RIO VOLUME - LARGA</span>          
      ...
      <table id="div_terminais">
        ...
        <tbody>              
          <?php foreach ($terminais as $terminal){
            ...
            $ordem_terminal[$terminal["terminal"]] = $total_programa;
          }
          ?>
        </tbody>    
        <tfoot>
  ...
  <div style="color:#FFF;">
    <?php echo "<pre>".print_r(ordem_terminal,1)."</pre>"; ?>
  </div>
</body>
</html>